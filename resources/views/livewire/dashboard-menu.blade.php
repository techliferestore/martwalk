...
Bookings <span>0</span>
 ...
 Reviews
        ...
        <a href="#" wire:click="logout" class="log-out-btn color-bg">Log Out <i class="far fa-sign-out"></i></a>
    </div>
</div>                    
...
<div class="dasboard-menu">
    ...
    @if($profile)
        ...
        @endif
            ...
            <a href="{{route('dashboard')}}"wire:click.prevent="edit_profile({{Auth::user()->id}})"> <i class="far fa-user" ></i>Profile</a>
        ...
        <li class="">
        @endif
        <a href="{{route('dashboard')}}"wire:click.prevent="edit_booking()"> <i class="far fa-calendar-check"></i>
        ...
        <li class="">
        @endif
        <a href="{{route('dashboard')}}"wire:click.prevent="edit_review()"><i class="far fa-comments">
        </i> Reviews </a></li>
